...
// with VIEWER_TEST_FAST_TIMERS set, timers of 10 s or more run 50 times sooner, so the 10-second
// check timeout and the 20-second keep-alive ping are reached in a test instead of after a wait.
